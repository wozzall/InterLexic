...
enum FlashCardsState {
    case empty, all, bySourceLanguage, byTargetLanguage, byBothLanguages
}
...
struct CardsTESTView: View {
    ...
    @State var sourceLanguageState: SelectorState = .notSelected
    @State var sourceLanguageFilter: String = String()
    @State var targetLanguageState: SelectorState = .notSelected
    @State var targetLanguageFilter: String = String()
    @State var flashCardsViewState: FlashCardsState = .empty
        ...
        withAnimation {
            for offset in offsets{
                if let index = flashCardStorage.flashCards.firstIndex(of: filteredFlashCards[offset]) {
                    flashCardStorage.flashCards.remove(at: index)
